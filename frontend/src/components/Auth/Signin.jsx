...
function Signin() {
    return (
        <div className="w-full flex  relative bg-neutral-100">
            <Logo />
            <div className="lg:w-[612px] md:w-[650px] w-[300px] m-auto mt-[173px] inline-flex flex-col items-center md:gap-[20px] gap-[25px] p-[35px] relative bg-white rounded-md">
