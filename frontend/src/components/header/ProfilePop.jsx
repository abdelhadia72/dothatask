...
function ProfilePop() {
    let worker = {firstname : "Alexander", lastname : "Elijah", categorie : 'freelancer' , image : user}
  return (
    <div className="md:w-[240px] w-[200px] h-[262px] py-[20px] absolute bg-white rounded-[5px] flex-col justify-center z-[1] items-start right-2 md:top-20 top-25 gap-[15px] inline-flex">
        <div className="self-stretch h-[115px] flex-col justify-start items-center gap-3.5 inline-flex"> 
            <div className="flex-col justify-start items-center gap-2.5 flex">
                <img className="w-[60px] h-[60px] rounded-full object-cover hover:opacity-60" src={worker.image}/>
                <div className="flex-col justify-start items-center gap-[5px] flex">
                    <div className="text-stone-950 text-sm font-medium font-Ubuntu">{worker.firstname} {worker.lastname}</div>
                    <div className="text-neutral-600 text-sm font-normal font-Ubuntu">{worker.categorie}</div>
                </div>
            </div>
