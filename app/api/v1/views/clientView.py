...
@app_v1.route('/client', methods=['POST'], strict_slashes=False)
def create_client():
...
@app_v1.route('/client', methods=['GET'], strict_slashes=False)
def get_clients():
    """ get all clients """
...
@app_v1.route('/client/<client_id>', methods=['GET'], strict_slashes=False)
...
@app_v1.route('/client/<client_id>', methods=['DELETE'], strict_slashes=False)
...
@app_v1.route('/client/<client_id>', methods=['PUT'], strict_slashes=False)
